	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<form id="addExceptionBehaviourForm" action="addExceptionBehaviour">
					<div class="row">
						<div class="form-group col-md-4">
							<label>异常行为:</label> <input type="text"
								class="form-control" name="behaviour" placeholder="异常行为">
						</div>
					...
					<button class="btn btn-primary" onclick="addExceptionBehaviour">添加</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</form>
			</div><!--/span-->
