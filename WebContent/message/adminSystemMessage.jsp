		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<table class="table table-hover">
					<tr><th>标题</th><th>发布时间</th><th>详情</th></tr>
					<c:forEach var="item" items="${sms}">
						<tr>
							...
							<td><a href="changeSystemMessageDemo?id=${item.id}">修改</a></td>
							<td><a href="deleteSystemMessage?id=${item.id}">删除</a></td>
						</tr>
					</c:forEach>
				</table>
				<a href="createSystemMessageDemo">发布新消息</a>
				</div>
			</div><!--/span-->
