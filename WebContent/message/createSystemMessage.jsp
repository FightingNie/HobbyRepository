	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<form id="createSystemMessage" action="createSystemMessage">
					<div class="row">
						<div class="form-group col-md-4">
						
							<label>标题：</label> <input type="text" value=""
								class="form-control title" name="title" placeholder="标题">
						</div>
						<div class="form-group col-md-4">
							<label>消息内容:</label> <input type="text" value=""
								class="form-control content" name="content" placeholder="消息内容">
						</div>
					</div>
					<button class="btn btn-primary" onclick="createSystemMessage">发布</button>
				</form>
			</div><!--/span-->
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="changeMyMessageForm" action="changeMyMessage">
		        <div class="form-group">
	      ...
	      <div class="modal-footer">
	       ...
	       <!-- <button type="button" class="btn btn-primary" onClick="window.location.href('changeMyMessage')">修改</button> --> 
	      </div>
	    </div>
	  </div>
	</div>
