...
<body style="background-color:#fff">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<table class="table table-hover">
					...
					<c:forEach var="item" items="${rejectList}">
						<tr>
							...
							<td><a data-toggle="modal" data-target="#adminRejectModal" data-itemid="${item.id}" data-content="${item.content}" href="#">答复</a></td>
	...
	<!-- Modal -->
	<div class="modal fade" id="adminRejectModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel">答复投诉</h4>
	      </div>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" onClick="reject.answerReject()">答复</button>
	      </div>
	    </div>
	  </div>
	</div>
