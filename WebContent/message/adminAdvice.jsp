...
<script src="message/adviceJS.js"></script>
</head>
...
<body style="background-color:#fff">
				...
				<table class="table table-hover">
					...
					<c:forEach var="item" items="${adviceList}">
						<tr>
							...
							<td><a data-toggle="modal" data-target="#adminAdviceModal" data-itemid="${item.id}" data-content="${item.content}" href="#">答复</a></td>
							<%-- <td><button class="btn btn-primary" onClick="leaveMessage.deleteMyMessage(${item.id})">删除</button></td> --%>
	...
	<!-- Modal -->
	<div class="modal fade" id="adminAdviceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel">答复建议</h4>
	      </div>
	      <div class="modal-body">
	        <form id="adminAdviceForm">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" onClick="advice.answerAdvice()">答复</button>
	      </div>
	    </div>
	  </div>
	</div>
