			...
			<div class="col-xs-12 col-sm-9">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				  ...
				  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
					...
					<form id="searchExternalMessageForm" action="searchExternalMessage">
							<div class="row">
								<div class="form-group col-md-4">
									<label>输入身份证号:</label> <input type="text" 
										class="form-control cardNo" name="cardNo" placeholder="身份证号">
								</div>
								<div class="form-group col-md-4">
									<label>输入体检日期:</label> <input type="text" 
										class="form-control date" name="date" placeholder="yyyy-mm-dd">
								</div>
							</div>
							<button class="btn btn-primary" onclick="searchExternalMessage">查询</button>
						</form>
				<!-- 
