	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="table-responsive">
				...
				${message}
					<tr><th>左眼视力</th><th>右眼视力</th><th>色觉</th><th>眼科检查员</th><th>结论</th></tr>
						<tr>
							<td>${em.leftEye}</td><td>${em.rightEye}</td><td>${em.colorSense}</td>
							<td>${em.eyeInspector}</td><td>${em.comment}</td>
				...
				<c:if test="${!empty em}">
				<button class="btn btn-primary" data-toggle="modal" data-target="#confirmModal" data-itemid="${em.id}">删除</button>
				<a href="updateEyeMessageDemo?id=${em.id}" class="btn btn-primary">修改记录</a>
				</c:if>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <button type="button" class="btn btn-primary" onclick="healthyActivity.delEyeMessage()">确认</button>
	      </div>
	        </form>
	      </div>
	    </div>
	...
	<div class="modal fade" id="publishModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel">眼科记录</h4>
	      </div>
	      <div class="modal-body">
	      	<form id="publishForm">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
	        <button type="button" class="btn btn-primary" onClick="healthyActivity.submitEyeMessage()">提交</button>
	      </div>
	    </div>
	  </div>
	</div>
