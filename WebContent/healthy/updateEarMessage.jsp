...
<body style="background-color:#fff">
	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<form id="changeEarMessageForm" action="changeEarMessage">
					<div class="row">
						<div class="form-group col-md-4">
							<label>左耳：</label> <input type="text" value="${earMessage.leftEar}"
								class="form-control leftEye" name="leftEye" placeholder="${earMessage.leftEar}">
						</div>
						<div class="form-group col-md-4">
							<label>右耳：</label> <input type="text" value="${earMessage.rightEar}"
								class="form-control rightEye" name="rightEye" placeholder="${earMessage.rightEar}">
						</div>
						<div class="form-group col-md-4">
							<label>检查结果：</label> <input type="text" value="${earMessage.comment}"
								class="form-control comment" name="comment" placeholder="${earMessage.comment}">
						</div>
						<div class="form-group col-md-4">
							<label>检查日期：</label> <input type="text" value="${earMessage.date}"
								class="form-control date" name="date" placeholder="${earMessage.date}">
						</div>
					</div>
					<input type="hidden" value="${earMessage.id }" name="id">
					<button class="btn btn-primary" onclick="changeEarMessage">修改</button>
				</form>
