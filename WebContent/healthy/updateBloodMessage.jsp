...
<body style="background-color:#fff">
	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<form id="changeBloodMessageForm" action="changeBloodMessage">
					<div class="row">
						<div class="form-group col-md-4">
							<label>检查日期：</label> <input type="text" value="${bloodMessage.date}"
								class="form-control date" name="date" placeholder="${bloodMessage.date}">
						</div>
						<div class="form-group col-md-4">
							<label>检查结果：</label> <input type="text" value="${bloodMessage.comment}"
								class="form-control comment" name="comment" placeholder="${bloodMessage.comment}">
						</div>
						<div class="form-group col-md-4">
							<label>检查人：</label> <input type="text" value="${bloodMessage.bloodInspector}"
								class="form-control bloodInspector" name="bloodInspector" placeholder="${bloodMessage.bloodInspector}">
						</div>
					</div>
					<input type="hidden" value="${bloodMessage.id }" name="id">
					<button class="btn btn-primary" onclick="changeBloodMessage">修改</button>
				</form>
