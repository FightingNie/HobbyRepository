...
<body style="background-color:#fff">
	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<form id="changeExternalMessageForm" action="changeExternalMessage">
					<div class="row">
						<div class="form-group col-md-4">
							<label>身高：</label> <input type="text" value="${externalMessage.height}"
								class="form-control height" name="height" placeholder="${externalMessage.height}">
						</div>
						<div class="form-group col-md-4">
							<label>体重：</label> <input type="text" value="${externalMessage.weight}"
								class="form-control weight" name="weight" placeholder="${externalMessage.weight}">
						</div>
						<div class="form-group col-md-4">
							<label>皮肤：</label> <input type="text" value="${externalMessage.skin}"
								class="form-control skin" name="skin" placeholder="${externalMessage.skin}">
						</div>
						<div class="form-group col-md-4">
							<label>脊柱四肢：</label> <input type="text" value="${externalMessage.extremitiesAndSpine}"
								class="form-control extremitiesAndSpine" name="extremitiesAndSpine" placeholder="${externalMessage.extremitiesAndSpine}">
						</div>
						<div class="form-group col-md-4">
							<label>其他：</label> <input type="text" value="${externalMessage.others}"
								class="form-control others" name="others" placeholder="${externalMessage.others}">
						</div>
						<div class="form-group col-md-4">
							<label>检查结果：</label> <input type="text" value="${externalMessage.comment}"
								class="form-control comment" name="comment" placeholder="${externalMessage.comment}">
						</div>
						<div class="form-group col-md-4">
							<label>检查日期：</label> <input type="text" value="${externalMessage.date}"
								class="form-control date" name="date" placeholder="${externalMessage.date}">
						</div>
					</div>
					<input type="hidden" value="${externalMessage.id }" name="id">
					<button class="btn btn-primary" onclick="changeExternalMessage">修改</button>
				</form>
