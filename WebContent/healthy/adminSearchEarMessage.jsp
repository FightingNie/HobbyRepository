	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="table-responsive">
				...
				${message}
					<tr><th>左耳</th><th>右耳</th><th>耳科检查员</th><th>结论</th></tr>
						<tr>
							<td>${earm.leftEar}</td><td>${earm.rightEar}</td>
							<td>${earm.earInspector}</td><td>${earm.comment}</td>
				...
				<c:if test="${!empty earm}">
				<button class="btn btn-primary" data-toggle="modal" data-target="#confirmModal" data-itemid="${earm.id}">删除</button>
				<a href="updateEarMessageDemo?id=${earm.id}" class="btn btn-primary">修改记录</a>
				</c:if>
