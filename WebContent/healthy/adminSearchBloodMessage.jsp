	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<c:if test="${!empty bm}">
				<button class="btn btn-primary" data-toggle="modal" data-target="#confirmModal" data-itemid="${bm.id}">删除</button>
				<a href="updateBloodMessageDemo?id=${bm.id}" class="btn btn-primary" >修改记录</a>
				</c:if>
				<a href="addBloodMessageDemo?cardNo=${cardNo }" class="btn btn-primary" >添加记录</a>
				</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <button type="button" class="btn btn-primary" onclick="healthyActivity.delBloodMessage()">确认</button>
	      </div>
	        </form>
	      </div>
	    </div>
