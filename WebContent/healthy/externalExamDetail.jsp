	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<tr><td>姓名</td><td>${user.realName}</td><td>年龄</td><td>${user.age}</td><td>性别</td><td>${user.sex}</td><td>身高</td><td>${exm.height}cm</td></tr>
				<tr><td>体重</td><td>${exm.weight}kg</td><td>皮肤</td><td>${exm.skin}</td><td>脊柱四肢</td><td>${exm.extremitiesAndSpine}</td></tr>
				<tr><td>结论</td><td>${exm.comment}</td><td>外科检查员</td><td>${exm.externalInspector}</td></tr>
