	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<tr><td>姓名</td><td>${user.realName}</td><td>年龄</td><td>${user.age}</td><td>性别</td><td>${user.sex}</td></tr>
<!-- ${bodyBetail.chestX} -->
				<tr><td>结论</td><td>${cr.comment}</td><td>胸部透视检查员</td><td>${cr.chestInspector}</td></tr>				
					<!-- <tr><th>姓名</th><th>左眼视力</th><th>右眼视力</th><th>色觉</th><th>眼科检查员</th></tr>
						<tr>
							...
							<td>${bodyBetail.eyeInspector}</td>
								...
								<img src="image/0eb30f2442a7d933ad6a556fad4bd11372f001ef.jpg"  style="width:100px;height:100px;">
