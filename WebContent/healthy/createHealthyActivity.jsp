	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
					<form id="submitActivityForm" action="submitActivity">
							<div class="row">
								<div class="form-group col-md-4">
									<label>活动主题:</label> <input type="text" 
										class="form-control activityTheme" name="activityTheme" placeholder="活动主题">
								</div>
								<div class="form-group col-md-4">
									<label>活动内容:</label> <input type="text" 
										class="form-control activityContent" name="activityContent" placeholder="活动内容">
								</div>
								<div class="form-group col-md-6">
									<label>活动时间:</label> <input type="text"
										class="form-control activityTime" name="activityTime" placeholder="活动时间">
								</div>
								<div class="form-group col-md-6">
									<label>活动地点:</label> <input type="text"
										class="form-control activityAddr" name="activityAddr" placeholder="活动地点">
								</div>
							</div>
							<button class="btn btn-primary" onclick="submitActivity">发布活动</button>
						</form>
				<!-- 
				...
				<table class="table table-hover">
					...
					<c:forEach var="item" items="${healthyActivityList}">
						<tr>
							...
							<td><a data-toggle="modal" data-target="#healthyActivityModal" data-theme="${item.activityTheme}" data-content="${item.activityAddr}" data-membersstr="${item.membersStr}" data-time="${item.activityTime }" data-addr="${item.activityAddr }" href="#">详情</a></td>
