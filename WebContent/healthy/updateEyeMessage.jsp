...
<body style="background-color:#fff">
	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<form id="changeEyeMessageForm" action="changeEyeMessage">
					<div class="row">
						<div class="form-group col-md-4">
							<label>左眼：</label> <input type="text" value="${eyeMessage.leftEye}"
								class="form-control leftEye" name="leftEye" placeholder="${eyeMessage.leftEye}">
						</div>
						<div class="form-group col-md-4">
							<label>右眼：</label> <input type="text" value="${eyeMessage.rightEye}"
								class="form-control rightEye" name="rightEye" placeholder="${eyeMessage.rightEye}">
						</div>
						<div class="form-group col-md-4">
							<label>色觉：</label> <input type="text" value="${eyeMessage.colorSense}"
								class="form-control colorSense" name="colorSense" placeholder="${eyeMessage.colorSense}">
						</div>
						<div class="form-group col-md-4">
							<label>检查结果：</label> <input type="text" value="${eyeMessage.comment}"
								class="form-control comment" name="comment" placeholder="${eyeMessage.comment}">
						</div>
						<div class="form-group col-md-4">
							<label>检查日期：</label> <input type="text" value="${eyeMessage.date}"
								class="form-control date" name="date" placeholder="${eyeMessage.date}">
						</div>
					</div>
					<input type="hidden" value="${eyeMessage.id }" name="id">
					<button class="btn btn-primary" onclick="changeEyeMessage">修改</button>
				</form>
