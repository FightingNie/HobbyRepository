	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<font color="blue">情绪变化信息</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href="addEmotionMessageDemo"><font color="blue">添加情绪变化记录</font></a><br>
				<table class="table table-hover">
<tr><th><font color="blue">高兴频率</font></th><th><font color="blue">高兴程度</font></th><th><font color="blue">高兴行为</font></th><th><font color="blue">发怒频率</font></th><th><font color="blue">发怒程度</font></th><th><font color="blue">发怒行为</font></th><th><font color="blue">悲伤频率</font></th></tr>
				<c:forEach var="emo" items="${emotionMessages}">
				<tr><td>${emo.happyTimes}</td><td>${emo.happyLevel}</td><td>${emo.happyBehaviour}</td><td>${emo.angryTimes}</td><td>${emo.angryLevel}</td><td>${emo.angryBehaviour}</td><td>${emo.sadTimes}</td></tr>
				</c:forEach>
				...
				<font color="blue">异常行为信息</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href="addExceptionBehaviourDemo"><font color="blue">添加异常行为记录</font></a><br>
				<table class="table table-hover">
				<tr><th><font color="blue">异常行为</font></th><th><font color="blue">时间</font></th></tr>
				<c:forEach var="exce" items="${exceptionBehaviours}">
				<tr><td>${exce.behaviour}</td><td>${exce.date}</td></tr>
				</c:forEach>
				<tr>${excepmessage}</tr>
				</table>
				
				<font color="blue">综合评诊</font><!-- &nbsp;&nbsp;&nbsp;&nbsp;<a href="illnessrecord/addFamilyIllness.jsp"><font color="blue">添加家族病史</font></a><br> -->
				<table class="table table-hover">
				<tr><th><font color="blue">评诊结果</font></th><th><font color="blue">时间</font></th></tr>
				<c:forEach var="asse" items="${assessmentMessages}">
				<tr><td>${asse.assessment}</td><td>${asse.date}</td></tr>
				</c:forEach>
				<tr>${assemessage}</tr>
				</table>
