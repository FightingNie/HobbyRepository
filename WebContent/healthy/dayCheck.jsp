...
<script src="healthy/dayCheckJS.js"></script>
</head>
...
<body style="background-color:#fff">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<table class="table table-hover">
					<tr><th>检查日期</th><th>身高</th><th>体重</th><th>健康情况</th></tr>
					<c:forEach var="item" items="${dayCheckList}">
						<tr>
							<td>${item.date}</td><td>${item.height}</td><td>${item.weight}</td>
			...
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
				<div class="list-group">
						...
						<button id="todayDayCheck" onclick="" data-toggle="modal" data-target="#toDayCheckModal" class="btn btn-primary">今日体检</button>
				</div>
			</div><!--/span-->
		</div>
		<!--/row-->
	...
	<!-- Modal -->
	<div class="modal fade" id="toDayCheckModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel">今日体检</h4>
	      </div>
	      <div class="modal-body">
	        <form id="todayCheckForm">
	          <div class="form-group">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" onClick="dayCheck.submitTodayCheck()">提交</button>
	      </div>
	    </div>
	  </div>
	</div>
