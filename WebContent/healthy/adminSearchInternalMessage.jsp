	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="table-responsive">
				...
				${message}
					<tr><th>血压</th><th>心肺听诊</th><th>内科检查员</th><th>结论</th></tr>
						<tr>
							<td>${im.bloodPressure}</td><td>${im.heartAndLung}</td>
							<td>${im.internalInspector}</td><td>${im.comment}</td>
				...
				<c:if test="${!empty im}">
				<button class="btn btn-primary" data-toggle="modal" data-target="#confirmModal" data-itemid="${im.id}">删除</button>
				<a href="updateInternalMessageDemo?id=${im.id}" class="btn btn-primary">修改记录</a>
				</c:if>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <button type="button" class="btn btn-primary" onclick="healthyActivity.delInternalMessage()">确认</button>
	      </div>
	        </form>
	      </div>
	    </div>
