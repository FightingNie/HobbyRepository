	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<font color="blue">重大疾病</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href="addSeriousIllnessDemo"><font color="blue">添加疾病记录</font></a><br>
				<table class="table table-hover">
<tr><th><font color="blue">住院时间</font></th><th><font color="blue">起因</font></th><th><font color="blue">程度</font></th><th><font color="blue">住院地址</font></th><th><font color="blue">住院次数</font></th></tr>
				<c:forEach var="si" items="${sis}">
				<tr><td>${si.date}</td><td>${si.disease}</td><td>${si.level}</td><td>${si.hospitolAddress}</td><td>${si.hospitalizedTimes}</td></tr>
				</c:forEach>
				...
				<font color="blue">住院记录</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href="addHospitalizationRecordsDemo"><font color="blue">添加住院记录</font></a><br>
				<table class="table table-hover">
				<tr><th><font color="blue">住院时间</font></th><th><font color="blue">起因</font></th><th><font color="blue">程度</font></th><th><font color="blue">住院地址</font></th><th><font color="blue">住院次数</font></th></tr>
				<c:forEach var="hr" items="${hrs}">
				<tr><td>${hr.date}</td><td>${hr.disease}</td><td>${hr.level}</td><td>${hr.hospitolAddress}</td><td>${hr.hospitalizedTimes}</td></tr>
				</c:forEach>
				<tr>${hmessage}</tr>
				</table>
				
				<font color="blue">家族病史</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href="addFamilyIllnessDemo"><font color="blue">添加家族病史</font></a><br>
				<table class="table table-hover">
				<tr><th><font color="blue">与本人关系</font></th><th><font color="blue">病因</font></th><th><font color="blue">是否健在</font></th></tr>
				<c:forEach var="fi" items="${fis}">
				<tr><td>${fi.relationship}</td><td>${fi.disease}</td><td>${fi.alive}</td></tr>
				</c:forEach>
				<tr>${fmessage}</tr>
				</table>
