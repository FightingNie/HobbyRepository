	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<form id="form1" name="form1" method="post" action="servlet/fileLiverServlet" enctype="multipart/form-data">
				 <table border="0" align="center">
				  <tr>
				   <td>检查员：</td>
				   <td>
				    <input name="liverInspector" type="text" id="name" size="20" ></td>
				    <td>检查结果：</td>
				   <td>
				    <input name="comment" type="text" id="name" size="20" ></td>
				    <td>检查日期：</td>
				   <td>
				    <input name="date" type="text" id="name" size="20" ></td>
