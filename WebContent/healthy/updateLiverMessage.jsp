...
<body style="background-color:#fff">
	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<form id="changeLiverMessageForm" action="changeLiverMessage">
					<div class="row">
						<div class="form-group col-md-4">
							<label>检查日期：</label> <input type="text" value="${liverMessage.date}"
								class="form-control date" name="date" placeholder="${liverMessage.date}">
						</div>
						<div class="form-group col-md-4">
							<label>检查结果：</label> <input type="text" value="${liverMessage.comment}"
								class="form-control comment" name="comment" placeholder="${liverMessage.comment}">
						</div>
						<div class="form-group col-md-4">
							<label>检查人：</label> <input type="text" value="${liverMessage.liverInspector}"
								class="form-control liverInspector" name="liverInspector" placeholder="${liverMessage.liverInspector}">
						</div>
					</div>
					<input type="hidden" value="${liverMessage.id }" name="id">
					<button class="btn btn-primary" onclick="changeLiverMessage">修改</button>
				</form>
