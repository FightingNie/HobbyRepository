var main = {
	action : {
		...
		healthActivityClick:"/healthy_home/healthActivity",
	...
	healthExaminationClick:function(){
		this.cancelSelected();
		$("#healthExaminationButton").attr("class","list-group-item active");
		window.location.href = "healthExamination";
	},
	healthInfoClick:function(){
		this.cancelSelected();
		$("#healthInfoButton").attr("class","list-group-item active");
		window.location.href = "healthyAssessment";
	},
	...
	leaveMessageClick:function(){
		this.cancelSelected();
		$("#leaveMessageButton").attr("class","list-group-item active");
		window.location.href = "myLeaveMessages";
	},
