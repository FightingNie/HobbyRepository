	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<form id="addHospitalizationRecordsForm" action="addHospitalizationRecords">
					<div class="row">
						<div class="form-group col-md-4">
							<label>病因:</label> <input type="text"
								class="form-control" name="disease" placeholder="病因">
						</div>
						<div class="form-group col-md-6">
							<label>程度:</label> <input type="text"
								class="form-control" name="level" placeholder="程度">
						</div>
						<div class="form-group col-md-6">
							<label>住院地址:</label> <input type="text"
								class="form-control" name="hospitolAddress" placeholder="住院地址">
						</div>
					</div>
					<button class="btn btn-primary" onclick="addHospitalizationRecords">添加</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</form>
			</div><!--/span-->
