	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<form id="addFamilyIllnessForm" action="addFamilyIllness">
					<div class="row">
						<div class="form-group col-md-4">
							<label>与本人关系:</label> <input type="text"
								class="form-control" name="relationship" placeholder="与本人关系">
						</div>
						...
						<div class="form-group col-md-6">
							<label>是否健在:</label> <input type="text"
								class="form-control" name="alive" placeholder="是否健在">
						</div>
					</div>
					<button class="btn btn-primary" onclick="addFamilyIllness">添加</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</form>
			</div><!--/span-->
