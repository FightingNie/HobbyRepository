		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<table class="table table-hover">
					<tr><td>发起人</td><td>${makeCarHugUsername}</td></tr>
					<c:forEach var="item" items="${togetherUserList}">
						<tr><td>乘车人</td><td>${item.nickName}</td></tr>
					</c:forEach>
				</table>
				<a href="joinCarHug?hugId=${hugId}">加入拼车</a>
				</div>
			</div><!--/span-->
