		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<table class="table table-hover">
					<tr><th>小区名称</th><th>上车点</th><th>下车点</th><th>人数</th><th>时间</th><th>路费</th><th>发起人</th><th>联系方式</th><th>详情</th><th>操作</th></tr>
					<c:forEach var="item" items="${carHugList}">
						<tr>
							...
							<!-- <td><a data-toggle="modal" data-target="#showHugModal" data-itemid="${item.carHug.id}" data-membersstr="${item.carHug.membersStr}" href="myCarHugDetailz">详情</a></td> -->
							<td><a href="myCarHugDetail?hugId=${item.carHug.id}">详情</a></td>
							<td><a href="cancelCarHug?hugId=${item.carHug.id}">取消拼车</a></td>
						</tr>
					</c:forEach>
				</table>
				</div>
