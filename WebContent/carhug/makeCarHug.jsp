...
<script src="carhug/makeCarHugJS.js"></script>
</head>
	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<form id="makeCarHugForm" action="makeCarHugAction">
					<input type="hidden" name="makeCarHugUserId" value="${user.id}"/>
					<input type="hidden" name="societyId" value="${user.societyId}"/>
						<div class="row">
							<div class="form-group col-md-4">
								<label >上车地点</label> <input type="text"
									class="form-control name" name="inCarAddr" placeholder="输入上车地点">
							</div>
							<div class="form-group col-md-4">
								<label for="type">下车地点</label> <input type="text"
									class="form-control type" name="outCarAddr" placeholder="输入下车地点">
							</div>
							<div class="form-group col-md-4">
								<label for="type">乘坐人数</label> <input type="number"
									class="form-control seatNumber" name="seatNumber" placeholder="输入乘车人数">
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-4">
								<label >车费</label> <div class="input-group"><input type="text"
									class="form-control raiseuserid" name="tripMoney"
									placeholder="车费"> <span class="input-group-addon">元</span></div>
							</div>
							<div class="form-group col-md-4">
								<label >时间</label> <input type="text"
									class="form-control" name="hugTime" placeholder="时间">
							</div>
							<div class="form-group col-md-4">
								<label >联系电话</label> <input type="text"
									class="form-control" name="phoneNumber" placeholder="联系电话">
							</div>
						</div>
						<input type="submit" name="submit" value="确定">
						<!-- <button class="btn btn-primary" onclick="makeCarHug.commitMakeCarHug()">确定</button> -->
					</form>
			</div><!--/span-->
