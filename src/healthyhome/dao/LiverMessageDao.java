...
@Repository("LiverMessageDao")
public class LiverMessageDao extends BaseDao {
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public <E> List<E>  findByUidAndId(LiverMessage instance){
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public <E> List<E>  findById(LiverMessage instance){
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public <E> List<E>  findByUid(LiverMessage instance){
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public <E> List<E>  findByUidAndDate(LiverMessage instance){
